...
#Iriis Voice Controlled AI

#I planned on adding this into the Web App.

from sys import dllhandle
from pyttsx3 import engine
import speech_recognition as sr
from gtts import gTTS
import standardsec as my
import datetime
import warnings
import webbrowser
import requests
...
while True:
    ...
    if (wakeWord(text) == True):
        ...
        if('navigate dashboard' in text):
            webbrowser.open_new_tab("https://www.mayrealities.com/dashboard") 
